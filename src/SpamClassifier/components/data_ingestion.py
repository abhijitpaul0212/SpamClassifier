...
from src.SpamClassifier.utils.data_processor import CSVProcessor, DBProcessor
...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        ...
        try:
            ...
            data = self.utils.run_data_pipeline(self.csv_processor, "notebooks/data", "SMSSpamCollection.csv", header=None, sep="\t", names=['label', 'messages'])
